...
$ServicePrincipalSecret = az ad sp create-for-rbac  --name "gh-action-to-deploy-fingerflitzer-webapp-viek" `
                          --role contributor  `
...
--repo The4t/5AHWII2526-HTLVBFingerflitzer `
...
$ServicePrincipal = az ad sp list --display-name "gh-action-to-deploy-fingerflitzer-webapp-viek" |  ConvertFrom-Json
